...
// holes.
func NewPolygon(xys ...XYer) (*Polygon, error) { _ = "STUB: not implemented"; return nil, nil }

// Plot draws the polygon, implementing the plot.Plotter
// interface.
func (pts *Polygon) Plot(c draw.Canvas, plt *plot.Plot) { _ = "STUB: not implemented"; return }
...
func (pts *Polygon) Thumbnail(c *draw.Canvas) { _ = "STUB: not implemented"; return }
